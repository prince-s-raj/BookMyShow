...
const NavBarSmall = () =>{
    return(
        <>
            <nav className="w-full bg-orange-200 ">Mobile or Small Screens
                <div className="inline-flex m-10"> 
                    <h1 className="text-black font-bold">  Its All Starts Here....! </h1>
                    <div>
    ...
    return(
        <>
            <nav className="w-full bg-orange-200">
                <div className="w-full flex gap-5 items-center bg-gray px-3 py-2">
                    <div>Logo</div>
                    <div>searchbar <BiSearch/></div>
                    <div>dropbox</div>
    ...
    return(
        <>
            <div className="w-full">
                <header className="w-full bg-gray-700 grid grid-cols-3 grid-rows-1 p-2">
                    <div className="px-10"> 
                    ...
                    <div className="flex">
                        <BiSearch className="search-symbol"/>
                        <input type="search" 
                        className="search bg-white  px-5 rounded-lg text-sm focus:outline-none" 
                        placeholder="Search for Movies, Events, Plays, Sports, and Activities"
                        />
                    </div>
                    <div className="grid grid-cols-3 p-2">
                        <div className="w-60 mx-10 flex drop">
                            <select name="city">
                                <option value="c">chennai</option>
                                <option value="l">London</option>
                                <option value="p">Paris</option>
                                <option value="s">Swis</option>
                            </select>
                        </div>
                        <button className=" px-2 py-1 w-20 bg-red-500 hover:bg-red-700 text-white rounded">
                            Sign
                        </button>
                        <div className="mx-0">
                ...
                <nav className="w-full bg-gray-800 flex gap-5 items-center bg-gray px-3 py-2 "> 
                    <ul className="w-full flex gap-3 items-center text-gray-300 ">
                        <li className="hover:text-white-900 px-10"><a href="#">Movies</a></li>
                        <li><a href="#">stream</a></li>
                        <li><a href="#">envents</a></li>
                        <li><a href="#">plays</a></li>
                        <li><a href="#">sports</a></li>
                        <li><a href="#">activities</a></li>
                        <li><a href="#">buzz</a></li>
                    </ul>
                    <ul className="w-full flex gap-3 items-center text-gray-300 px-(-30)">
                        <li><a href="#">List your show</a></li>
                        <li><a href="#">offers gift card</a></li>
                        <li><a href="#">List your show</a></li>
                        <li><a href="#">offers gift card</a></li>
                    </ul>
                </nav>
